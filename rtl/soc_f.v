// =====================================================================
// soc_f.v  -  Minimal SoC for the RV32IMF core: CPU + BRAM + SYSCON
// ---------------------------------------------------------------------
// Just enough system to run compiled rv32imf programs: the single-precision
// F-extension core, a word-wide instruction ROM, data RAM, and the SYSCON
// halt register.
//
//   0x0000_0000  RAM
